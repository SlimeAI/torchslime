...
class _BuildInterface:
    ...
    """
    def before_build_train(self, ctx: Context) -> None: pass
    def after_build_train(self, ctx: Context) -> None: pass
    def before_build_eval(self, ctx: Context) -> None: pass
    def after_build_eval(self, ctx: Context) -> None: pass
    def before_build_predict(self, ctx: Context) -> None: pass
    def after_build_predict(self, ctx: Context) -> None: pass
