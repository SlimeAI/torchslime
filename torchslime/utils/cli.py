...
# from .bases import AttrProxy

# class CLIInterceptor(TextIO, AttrProxy[TextIOWrapper]):
...
#         AttrProxy.__init__(self, text_io_wrapper, [
...
def refresh_print(
    *contents,
    ...
    """
    # TODO: deprecated
    from torchslime.components.store import NOTHING as BuiltinStoreSet
